...
function HookMoto() {
    ...
    useEffect(() => {
        const carregarMarcas = async () => {
            try {
                const response = await axios.get('https://parallelum.com.br/fipe/api/v1/motos/marcas');
    ...
    const carregarModelos = async (marca) => {
        try {
            const response = await axios.get(`https://parallelum.com.br/fipe/api/v1/motos/marcas/${marca}/modelos`);
    ...
    const carregarAnos = async (codigoModelo) => {
        try {
            const response = await axios.get(`https://parallelum.com.br/fipe/api/v1/motos/marcas/${marcaSelecionada}/modelos/${codigoModelo}/anos`);
    ...
    const handlePesquisarClick = async () => {
        try {
            const response = await axios.get(`https://parallelum.com.br/fipe/api/v1/motos/marcas/${marcaSelecionada}/modelos/${modeloSelecionado}/anos/${anoSelecionado}`);
